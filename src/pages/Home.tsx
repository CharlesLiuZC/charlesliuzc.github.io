...
const experiences: ExperienceItem[] = [
  {
    ...
    description: '独立负责新媒体渠道的产品引流与转化，通过数据驱动策略优化，推动用户增长与 GMV 提升。',
    highlights: [
      '独立负责 2 个新媒体渠道，策划 4 场线上活动，单场 GMV 超 13 万，单条内容曝光量破 10W+',
      '核心渠道月活增长 7000+（+40%），平均互动率提升 35%',
      '对接 12 位 KOL/KOC 提炼产品卖点，新品首月销售额达目标 120%',
    ],
    tags: ['产品运营', '数据分析', 'A/B测试'],
    icon: Megaphone,
  },
  {
    title: '中国工商银行 珠海拱北分行',
    ...
    description: '负责竞品分析、APP 产品推广与用户调研，通过数据驱动产品优化与用户增长。',
    highlights: [
      '完成 5 份深度竞品分析报告，覆盖产品功能、定价策略及推广渠道',
      '工行 APP 线下拉新与激活，下载量增长 183%',
      '设计并回收用户问卷，驱动金融产品购买量增长 74%',
    ],
    tags: ['竞品分析', '用户增长', '数据调研'],
    icon: BarChart3,
  },
  {
    ...
    description: '主导"春招""秋招"两场大型双选会，从 0 到 1 完成需求采集、资源协调、方案设计及落地交付。',
    highlights: [
      '对接 120+ 企业，协调 35 人团队执行，企业满意度达 98%+',
      '设计签到引导、一对一接待等动线，优化运营 SOP',
    ],
    tags: ['需求管理', '体验优化', '团队协作'],
    icon: Users,
  },
  {
    ...
    description: '发现特定类型图书借阅率低的用户痛点，策划并执行图书分享活动。',
    highlights: [
      '策划"图书分享"活动，线上线下触达方案获得 4000+ 次播放',
      '活动后相关书籍借阅量提升 379%，形成可复用的用户激活策略',
    ],
    tags: ['用户激活', '活动策划', '数据驱动'],
    icon: Library,
  },
  ...
  return (
    <section id="experience" className="py-24 sm:py-32 px-6 bg-gradient-to-b from-white to-stone-50/80">
      <div className="max-w-3xl mx-auto">
        <SectionTitle subtitle="产品运营、数据分析与用户增长的实战积累">
          实践经历
        </SectionTitle>
